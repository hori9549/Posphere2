...
Public Class Frm111レジメニュー設定
    ...
    Private Sub frm111レジメニュー設定_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        aryPbtnList(4) = btnページ５
        aryPbtnList(5) = btnページ６
        aryPbtnList(6) = btnページ７
        aryPbtnList(7) = btnページ８
    ...
    Sub UpperBtnNot(ByVal kaisu As Integer)  '＝＝＝＝　Upper Bottons　早戻しボタン等　を　Lock,unlock　＝＝＝＝
        ...
        End If
    End Sub
    '＝＝＝＝　Page1～8　早戻しボタン等　を　Lock　＝＝＝＝
    Sub PageBtnGroupeNot(ByVal kaisu As Integer)        'Page1～8　早戻しボタン等　を　Lock
        If kaisu <= 2 Then       'Lock,UnLockで動作終了
...
Dtbl読込:
    ...
    Private Sub btnページ1_Click(sender As Object, e As EventArgs) Handles btnページ１.Click, btnページ２.Click,
        btnページ３.Click, btnページ４.Click, btnページ５.Click, btnページ６.Click, btnページ７.Click, btnページ８.Click
    ...
    Private Sub btn基本色_Click(sender As Object, e As EventArgs) Handles btn基本色.Click
...
Mitsuketa:       'Mode によって分ける
    ...
    Sub Show8(ByVal LeftNum As Integer)      'ページボタンを8つ表示
        '------Btnページの表示---------------
    ...
    Private Sub btn送り_Click(sender As Object, e As EventArgs) Handles btn送り.Click
        If PBLEN + 1 > 32 Then     '右からはみ出る  Left=P33 Right=P40
            Exit Sub
        End If
...
GoToShow8:
    ...
    Sub BtnPopUP()   '選択したPageが、はみ出していないなら強調表示
        If SelPageNo - PBLEN > 0 And SelPageNo - PBLEN <= 8 Then
