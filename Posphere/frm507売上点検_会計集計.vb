...
''20200228漆谷　金種入力用のテンキーボタンを追加-------------------------------
''20200306漆谷　テンキーボタンの挙動を追加を追加-------------------------------
''20200317漆谷　金種表の小計と金額の入力機能を追加-------------------------------
''20200321漆谷　集計結果を表示する機能を追加-------------------------------
''20200907漆谷　SQLにエラー時のTry/Catch処理を追加-------------------------------

Imports System.Data
Imports System.Data.SqlClient

Public Class frm507売上点検_会計集計
    ...
    Private Sub frm506売上点検_Load(sender As Object, e As EventArgs) Handles MyBase.Load
